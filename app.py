from flask import Flask, abort, render_template, request, session, flash, redirect, url_for
...
def exibir_entradas():
    ...
    return render_template('exibir_entradas.html', entradas=entradas) #referenciar posts
